...
public class DetailFragment extends BaseFragment {
    ...
    @BindView(R.id.social_view_views)
    TextView viewsProject;
    @BindView(R.id.social_view_likes)
    TextView likesProject;
    @BindView(R.id.social_view_comments)
    TextView commentsProject;
